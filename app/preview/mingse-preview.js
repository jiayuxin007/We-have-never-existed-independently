...
(function (global) {
    ...
    var EFFECTS = {
        ...
        'shou-dukha': {
            ...
            subtitle: 'Overload. The system rejects the contact as pain.',
        },
        'shou-sukha': {
            label: '乐受',
            durationS: 8,
            note: '0–1s 触余震平复 → 1–6s 宽幅正弦向心吸附 + 钛白泛光 → 6–8s 阻尼 · 人/天 · 循环',
            subtitle: 'Resonance. The current is received as pleasure.',
        },
        'shou-upeksha': {
            label: '舍受',
            durationS: 8,
            note: '0–1s 触余震平复 → 1–6s 零形变微呼吸 + 深苔灰扫描环（点云不变色） → 6–8s 阻尼 · 畜生 · 循环',
            subtitle: 'Equanimity. Data passes through without a mark.',
        },
        ai: {
            label: '爱',
            durationS: 8,
            note: '房屋点云 8s 聚成二维粒子球，同时慢慢升到上方 · 交互对齐 sketch2812705',
            subtitle: 'To stitch fractured projections, as if to catch a never-offline twilight alive in cache-delay.',
        },
        qu: {
            label: '取',
            durationS: 8,
